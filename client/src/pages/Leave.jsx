...
import { PalmtreeIcon, ThermometerIcon, UmbrellaIcon, PlusIcon } from "lucide-react"
...
const Leave = () => {
    ...
    const isAdmin = false; /// true --> Admin view; false --> Emp view
    ...
    const annualCount = approvedLeaves.filter((l)=>l.types === "ANNUAL").length;
