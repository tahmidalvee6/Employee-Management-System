...
declare namespace errors_d_exports {
  export { ErrCode, OutgoingResultError, SerializedError$1 as SerializedError, UnreachableError, deserializeError$1 as deserializeError, fixEventKeyMissingSteps, getErrorMessage, isSerializedError, rethrowError, serializeError$1 as serializeError };
}
