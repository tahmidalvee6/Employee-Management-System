...
declare namespace errors_d_exports {
  export { ErrCode, OutgoingResultError, SerializedError$1 as SerializedError, UnreachableError, deserializeError, fixEventKeyMissingSteps, getErrorMessage, isSerializedError, rethrowError, serializeError };
}
